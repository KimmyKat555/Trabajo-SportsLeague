...
namespace SportsLeague.API.Controllers
{
    ...
    public class SponsorController : ControllerBase
    {
        ...
        [HttpPost("tournament")]
        public async Task<ActionResult<TournamentSponsorResponseDTO>> AddToTournament(TournamentSponsorRequestDTO request)
        {
            var relation = _mapper.Map<TournamentSponsor>(request);
            var result = await _sponsorService.AddSponsorToTournamentAsync(relation);
